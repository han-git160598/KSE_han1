                                    ...
                                    <div class="full-height-scroll">
                                       <div class="table-responsive">
                                          <table class="table table-striped table-hover">
                                            <tr>
                                                <th><a data-toggle="tab" class="client-link">Tên</a></th>
                                                <th>Số điện thoại</th>
                                             ...
                                             <tbody id="content-customer">
                                                <tr>
                                                    ...
                                                    <td>24/05/2021</td>
                                                    <td>80%</td>
                                                    <td><button type="button" name="x" id="x" data-toggle="modal" data-target="#detail_customer" class="btn btn-success btn-sm"><i class="fa fa-pencil-square"></i> Chi tiết  </button></td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </div>
