...
function filter_history()
{
    ...
    $.ajax({
        url: urlapi,
        type: 'POST',
        data: {detect:'list_customer_history',type_manager:'customer',id_customer:id,
...
function type_sort()
{
    ...
    $.ajax({
        url: urlapi,
        type: 'POST',
        data: {detect:'sale_support_customer', type_manager:'list_customer',limit:'200',type_sort:type_sort},
        dataType: 'json',
        success: function (response) 
        { 
            var output = `
